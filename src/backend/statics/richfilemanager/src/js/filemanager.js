...
(function($) {
    ...
    $.richFilemanagerPlugin = function(element, pluginOptions) {
        ...
        var initialize = function() {
            ...
            capabilities = config.options.capabilities || ['upload', 'select', 'download', 'rename', 'copy', 'move', 'delete', 'extract', 'createFolder', 'search'];
            ...
            var PreviewModel = function() {
                ...
                this.rdo.subscribe(function(resourceObject) {
                    preview_model.cdo({
                        ...
                        meta: resourceObject.attributes.meta ? resourceObject.attributes.meta : {},
                    });
                });
                ...
                this.buttonVisibility = function(action) {
                    switch (action) {
                        ...
                        case 'search':
                            return (isObjectCapable(preview_model.rdo(), 'search'))
                    }
                };
            };
        ...
        function isObjectCapable(resourceObject, capability) {
            ...
            if (capability === 'search_info') {
                console.log(resourceObject.type === 'file')
                return resourceObject.type === 'file';
            }
        ...
        function getContextMenuItems(resourceObject) {
            var clipboardDisabled = !fmModel.clipboardModel.enabled(),
                contextMenuItems = {
                    ...
                    search: { name: lg('action_search'), className: 'search' },
...
// add the plugin to the jQ uery.fnobject
